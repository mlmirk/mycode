...
def main():
    ...
    while game_number < number_of_games:
        ...
        if sum(hamstrung.get_dice()) == sum(loaded_dice.get_dice()):
            #print("Draw!")
            pass
        elif sum(hamstrung.get_dice()) > sum(loaded_dice.get_dice()):
    ...
    print("Final scores")
    print("------------")
    print(f"hamstrung won: {swapper_score}")
    ...
    if swapper_score == loaded_dice_score:
        ...
        print("hamstrung won most games")
    else:
